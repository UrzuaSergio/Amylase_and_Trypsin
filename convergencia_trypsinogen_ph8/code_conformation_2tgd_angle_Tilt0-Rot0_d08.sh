...
python generador_config_file.py 2tgd_isolated 2tgd geometry/2tgd_d08 0 0 2

echo "Se ha Creado Config File Auxiliar"
echo "Comenzo Ejecucion de PyGBe para Caso Proteina-Superficie Interactuando"
echo "%%%%%%%% Simulando %%%%%%%%"

python conformation_1hel.py 2tgd_isolated 2tgd_isolated/2tgd 2tgd_isolated/geometry/2tgd_d08 0 0 1 2 2tgd_d08-isolated_Tilt0-Rot0-2_EF1e-12
