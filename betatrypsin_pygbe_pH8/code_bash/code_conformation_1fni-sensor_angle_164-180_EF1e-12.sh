...
#SBATCH -p gpuk 
#SBATCH --gres=gpu:1 
#SBATCH -J 1fni-sensor_164-180_pH8_EF1e-12 
#SBATCH -o 1fni-sensor_164-180_pH8_EF1e-12-%j.out 
#SBATCH -e 1fni-sensor_164-180_pH8_EF1e-12-%j.err 
#SBATCH --mem=2G 
...
python conformation_1hel.py 1fni_sensor 1fni_sensor/1fni 1fni_sensor/geometry/1fni_d08_split 164 180 5 2 1fni-sensor_164-180-2_EF1e-12 
