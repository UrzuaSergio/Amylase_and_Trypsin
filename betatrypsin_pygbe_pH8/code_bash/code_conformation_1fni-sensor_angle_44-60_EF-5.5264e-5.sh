...
#SBATCH -p gpuk 
#SBATCH --gres=gpu:1 
#SBATCH -J 1fni-sensor_44-60_pH8_EF-5.5264e-5 
#SBATCH -o 1fni-sensor_44-60_pH8_EF-5.5264e-5-%j.out 
#SBATCH -e 1fni-sensor_44-60_pH8_EF-5.5264e-5-%j.err 
#SBATCH --mem=2G 
...
python conformation_1hel.py 1fni_sensor 1fni_sensor/1fni 1fni_sensor/geometry/1fni_d08_split 44 60 5 2 1fni-sensor_44-60-2_EF-5.5264e-5 
