...
#SBATCH -p gpuk 
#SBATCH --gres=gpu:1 
#SBATCH -J 1fni-sensor_104-120_pH8_EF5.5264e-5 
#SBATCH -o 1fni-sensor_104-120_pH8_EF5.5264e-5-%j.out 
#SBATCH -e 1fni-sensor_104-120_pH8_EF5.5264e-5-%j.err 
#SBATCH --mem=2G 
...
python conformation_1hel.py 1fni_sensor 1fni_sensor/1fni 1fni_sensor/geometry/1fni_d08_split 104 120 5 2 1fni-sensor_104-120-2_EF5.5264e-5 
