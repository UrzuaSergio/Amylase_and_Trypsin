...
#SBATCH -p gpuk 
#SBATCH --gres=gpu:1 
#SBATCH -J pepm1-sensor_64-80_pH5.4_EF5.5264e-5 
#SBATCH -o pepm1-sensor_64-80_pH5.4_EF5.5264e-5-%j.out 
#SBATCH -e pepm1-sensor_64-80_pH5.4_EF5.5264e-5-%j.err 
#SBATCH --mem=2G 
...
python conformation_1hel.py pepm1_sensor pepm1_sensor/peptido_model1_ph5.4_parse pepm1_sensor/mesh/peptido_m1_ph5.4_parse_p1.4_d04 64 80 5 2 pepm1-sensor_64-80-2_EF5.5264e-5 
