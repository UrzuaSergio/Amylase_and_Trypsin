...
#SBATCH -p gpuk 
#SBATCH --gres=gpu:1 
#SBATCH -J pepm1-sensor_124-140_pH5.4_EF-5.5264e-5 
#SBATCH -o pepm1-sensor_124-140_pH5.4_EF-5.5264e-5-%j.out 
#SBATCH -e pepm1-sensor_124-140_pH5.4_EF-5.5264e-5-%j.err 
#SBATCH --mem=2G 
...
python generador_config_file.py pepm1_sensor peptido_model1_ph5.4_parse mesh/peptido_m1_ph5.4_parse_p1.4_d04 124 140 2 
 
echo "Se ha Creado Config File Auxiliar" 
echo "Comenzo Ejecucion de PyGBe para Caso Proteina-Superficie Interactuando" 
echo "%%%%%%%% Simulando %%%%%%%%" 
 
python conformation_1hel.py pepm1_sensor pepm1_sensor/peptido_model1_ph5.4_parse pepm1_sensor/mesh/peptido_m1_ph5.4_parse_p1.4_d04 124 140 5 2 pepm1-sensor_124-140-2_EF-5.5264e-5 
