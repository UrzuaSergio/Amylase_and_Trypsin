...
python generador_config_file.py 1fni_sensor 1fni geometry/1fni_d16_split 154 154 2

echo "Se ha Creado Config File Auxiliar"
echo "Comenzo Ejecucion de PyGBe para Caso Proteina-Superficie Interactuando"
echo "%%%%%%%% Simulando %%%%%%%%"

python conformation_1hel.py 1fni_sensor 1fni_sensor/1fni 1fni_sensor/geometry/1fni_d16_split 154 154 1 2 1fni_d16-sensor_Tilt154-Rot90-2_EF1e-12
