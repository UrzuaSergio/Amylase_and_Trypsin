...
#SBATCH -p gpuk 
#SBATCH --gres=gpu:1 
#SBATCH -J 1a0j-sensor_44-60_pH8_EF1e-12 
#SBATCH -o 1a0j-sensor_44-60_pH8_EF1e-12-%j.out 
#SBATCH -e 1a0j-sensor_44-60_pH8_EF1e-12-%j.err 
#SBATCH --mem=2G 
...
python conformation_1hel.py 1a0j_sensor 1a0j_sensor/1a0j 1a0j_sensor/geometry/1a0j_d08_split 44 60 5 2 1a0j-sensor_44-60-2_EF1e-12 
