...
#SBATCH -p gpuk 
#SBATCH --gres=gpu:1 
#SBATCH -J 2tgd-sensor_0-20_pH8_EF-5.5264e-5 
#SBATCH -o 2tgd-sensor_0-20_pH8_EF-5.5264e-5-%j.out 
#SBATCH -e 2tgd-sensor_0-20_pH8_EF-5.5264e-5-%j.err 
#SBATCH --mem=2G 
...
python conformation_1hel.py 2tgd_sensor 2tgd_sensor/2tgd 2tgd_sensor/geometry/2tgd_d08 0 20 6 2 2tgd-sensor_0-20-2_EF-5.5264e-5 
