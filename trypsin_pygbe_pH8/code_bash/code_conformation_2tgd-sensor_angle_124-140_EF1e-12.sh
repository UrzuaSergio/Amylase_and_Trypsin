...
#SBATCH -p gpuk 
#SBATCH --gres=gpu:1 
#SBATCH -J 2tgd-sensor_124-140_pH8_EF1e-12 
#SBATCH -o 2tgd-sensor_124-140_pH8_EF1e-12-%j.out 
#SBATCH -e 2tgd-sensor_124-140_pH8_EF1e-12-%j.err 
#SBATCH --mem=2G 
...
python conformation_1hel.py 2tgd_sensor 2tgd_sensor/2tgd 2tgd_sensor/geometry/2tgd_d08 124 140 5 2 2tgd-sensor_124-140-2_EF1e-12 
