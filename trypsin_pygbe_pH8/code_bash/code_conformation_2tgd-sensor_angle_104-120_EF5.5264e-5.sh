...
#SBATCH -p gpuk 
#SBATCH --gres=gpu:1 
#SBATCH -J 2tgd-sensor_104-120_pH8_EF5.5264e-5 
#SBATCH -o 2tgd-sensor_104-120_pH8_EF5.5264e-5-%j.out 
#SBATCH -e 2tgd-sensor_104-120_pH8_EF5.5264e-5-%j.err 
#SBATCH --mem=2G 
...
python conformation_1hel.py 2tgd_sensor 2tgd_sensor/2tgd 2tgd_sensor/geometry/2tgd_d08 104 120 5 2 2tgd-sensor_104-120-2_EF5.5264e-5 
