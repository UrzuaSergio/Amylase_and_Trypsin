...
#SBATCH -p gpuk 
#SBATCH --gres=gpu:1 
#SBATCH -J 1smd-sensor_164-180_pH7_EF-5.5264e-5 
#SBATCH -o 1smd-sensor_164-180_pH7_EF-5.5264e-5-%j.out 
#SBATCH -e 1smd-sensor_164-180_pH7_EF-5.5264e-5-%j.err 
#SBATCH --mem=2G 
...
python conformation_1hel.py 1smd_sensor 1smd_sensor/1smd_mod 1smd_sensor/geometry/1smd_d08_split 164 180 5 2 1smd-sensor_164-180-2_EF-5.5264e-5 
