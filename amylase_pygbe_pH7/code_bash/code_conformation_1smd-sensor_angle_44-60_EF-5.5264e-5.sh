...
#SBATCH -p gpuk 
#SBATCH --gres=gpu:1 
#SBATCH -J 1smd-sensor_44-60_pH7_EF-5.5264e-5 
#SBATCH -o 1smd-sensor_44-60_pH7_EF-5.5264e-5-%j.out 
#SBATCH -e 1smd-sensor_44-60_pH7_EF-5.5264e-5-%j.err 
#SBATCH --mem=2G 
...
python generador_config_file.py 1smd_sensor 1smd_mod geometry/1smd_d08_split 44 60 2 
 
echo "Se ha Creado Config File Auxiliar" 
echo "Comenzo Ejecucion de PyGBe para Caso Proteina-Superficie Interactuando" 
echo "%%%%%%%% Simulando %%%%%%%%" 
 
python conformation_1hel.py 1smd_sensor 1smd_sensor/1smd_mod 1smd_sensor/geometry/1smd_d08_split 44 60 5 2 1smd-sensor_44-60-2_EF-5.5264e-5 
