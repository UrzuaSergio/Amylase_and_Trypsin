...
#SBATCH -p gpuk 
#SBATCH --gres=gpu:1 
#SBATCH -J 2tgd-sensor_144-160_pH8_EF-5.5264e-5 
#SBATCH -o 2tgd-sensor_144-160_pH8_EF-5.5264e-5-%j.out 
#SBATCH -e 2tgd-sensor_144-160_pH8_EF-5.5264e-5-%j.err 
#SBATCH --mem=2G 
...
python generador_config_file.py 2tgd_sensor 2tgd geometry/2tgd_d08 144 160 2 
 
echo "Se ha Creado Config File Auxiliar" 
echo "Comenzo Ejecucion de PyGBe para Caso Proteina-Superficie Interactuando" 
echo "%%%%%%%% Simulando %%%%%%%%" 
 
python conformation_1hel.py 2tgd_sensor 2tgd_sensor/2tgd 2tgd_sensor/geometry/2tgd_d08 144 160 5 2 2tgd-sensor_144-160-2_EF-5.5264e-5 
